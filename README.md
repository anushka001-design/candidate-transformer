...
| Source                 | Type         | Status    |
| ---------------------- | ------------ | --------- |
| Recruiter CSV          | Structured   | Supported |
| ATS JSON               | Structured   | Supported |
| Resume (PDF)           | Unstructured | Supported |
| Resume (DOCX)          | Unstructured | Supported |
| Recruiter Notes (.txt) | Unstructured | Supported |
...
| Skills        | Canonical Skill Dictionary |
| Emails        | Lowercase                  |
| URLs          | Standardized Format        |
